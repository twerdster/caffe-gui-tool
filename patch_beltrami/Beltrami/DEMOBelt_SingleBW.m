%% DEMO: Patch-Beltrami denoising (Grayscale version)
...
%% Input original
y = 255*double(im2double(imread('BM3D_images\house.png')));
...
%% Display output
imshow(uint8(abs([z y_est y])));xlabel(num2str(PSNR));pause(0.00001);
